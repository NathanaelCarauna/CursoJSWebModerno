...
function luckFunction(number) {
    const chooseNumber = Math.floor(Math.random() * 11)
    return number === chooseNumber ? "Congratulations! The drawn number was " + chooseNumber :'That\'s a shame! The drawn number was ' + chooseNumber     
}

console.log(luckFunction(10))
console.log(luckFunction(5))
console.log(luckFunction(5))